          ...
          {/* Stream Content Tabs */}
            ...
            <Tabs value={activeTab} onChange={(value) => setActiveTab(value)}>
              ...
              <TabsBody className="p-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="flex space-x-4">
                          <a href={streamData.socials.twitter} target="_blank" rel="noopener noreferrer" className="text-[#EBD3F8]/70 hover:text-[#EBD3F8] transition-colors">
                          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                          </svg>
                        </a>
                          <a href={streamData.socials.instagram} target="_blank" rel="noopener noreferrer" className="text-[#EBD3F8]/70 hover:text-[#EBD3F8] transition-colors">
                          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                          ...
                          <a href={streamData.socials.youtube} target="_blank" rel="noopener noreferrer" className="text-[#EBD3F8]/70 hover:text-[#EBD3F8] transition-colors">
                          <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <TabPanel value="clips" className="p-0">
                  <div className="text-center py-8">
                      ...
                      <p className="text-[#EBD3F8]/80">No clips available yet</p>
                  </div>
                </TabPanel>
              </TabsBody>
            </Tabs>
